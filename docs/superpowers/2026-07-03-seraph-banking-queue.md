...
- 2026-08-22: **LIVE PARAMETER AUDIBILITY SHIPPED — F3 + F13 + the banked
  `reload_snapshot`/`silence_all` follow-up, all ONE defect** (branch
  `fix/live-param-audibility`; lanes: cargo 253/0, vitest 292/292 across 29
  files, build clean, no bindings drift).
